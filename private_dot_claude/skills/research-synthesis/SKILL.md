...
When several independent sources need reading, delegate them as parallel narrow sub-agent queries (per the sub-agent strategy) rather than reading serially in the main context.
