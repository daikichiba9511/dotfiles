...
description: "Run evidence-backed product management workflows for discovery, user and market research, product strategy, PRDs and roadmaps, go-to-market, product analytics, and shipping readiness. Use when the user is making a product decision or asks for work such as 'プロダクトディスカバリーをしたい', 'ユーザー調査を整理して', '戦略を作りたい', 'PRDを書いて', 'ローンチ計画', 'North Star Metric', 'A/Bテストを分析して', or '出荷前に確認して'. Do not use for software implementation planning, generic code review, generic prose editing, resumes, or legal-document drafting."
---
