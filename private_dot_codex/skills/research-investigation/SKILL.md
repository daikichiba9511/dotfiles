...
description: "Plan and run research-heavy investigations with scoped subagents, evidence tables, critique, and experiment handoff. Use when the user asks to investigate papers, benchmarks, APIs, codebases, methods, or design choices before implementation; compare conflicting evidence; validate a research hypothesis; or structure exploration with research_scout, research_critic, and research_experimenter subagents."
---
