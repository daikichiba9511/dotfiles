...
| `index.md` is ambiguous | Use `rg` for question keywords across `pages/`. |
| `rg` returns more than 10 plausible hits | Narrow with more specific terms or ask the user to refine the question. |
