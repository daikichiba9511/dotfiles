---
name: pr
description: "Use only when the user explicitly asks to create a GitHub pull request with gh pr create. Produce a concise reviewer-oriented PR title and body; do not use for reviewing, updating, or merely discussing a pull request."
