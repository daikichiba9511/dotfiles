---
name: ml-cleanup
description: "Use after an ML experiment has stabilized when the user explicitly asks to remove dead exploratory code, consolidate duplicated experiment logic, or extract proven shared components. Do not use during active exploration or for non-ML refactoring."
