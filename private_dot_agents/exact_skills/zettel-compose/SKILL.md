---
name: zettel-compose
description: "Use when the user wants to create a document or writing plan specifically from an existing Zettelkasten: select memos, map relationships or gaps, propose an outline, or draft the output. Do not use for writing without Zettel sources."
