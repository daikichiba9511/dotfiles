---
name: llm-wiki-query
description: "Use when the user asks a question against an existing LLM Wiki, wants a source-backed synthesis from its pages, or wants that answer saved back to the wiki. Do not use for open-web research when no wiki is in scope."
