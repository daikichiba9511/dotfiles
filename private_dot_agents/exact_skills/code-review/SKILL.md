---
name: code-review
description: "Use for a read-only review of a working diff, branch diff, or named code files, with evidence-backed correctness, coupling, blast-radius, and test findings. Do not use when the user asks to implement fixes or requests a security-focused audit."
