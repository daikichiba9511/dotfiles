---
name: zettel-create
description: "Use when the user explicitly asks to persist one atomic concept or supplied or researched content as a Zettel in an existing Zettelkasten. Do not trigger for research that does not request a saved note or for general note-taking."
