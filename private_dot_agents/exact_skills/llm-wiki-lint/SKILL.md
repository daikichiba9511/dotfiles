---
name: llm-wiki-lint
description: "Use when the user asks to audit an existing LLM Wiki for stale claims, contradictions, broken links, orphan pages, missing coverage, or consistency. Do not use for general prose linting or source ingestion."
