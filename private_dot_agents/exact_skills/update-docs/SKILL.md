---
name: update-docs
description: "Use when the user asks to update existing project documentation so it matches completed code or behavior changes, or when documentation is an explicit deliverable. Do not use for session summaries or new long-form articles."
