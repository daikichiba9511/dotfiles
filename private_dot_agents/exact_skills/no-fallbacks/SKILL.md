---
name: no-fallbacks
description: "Use only when a proposed code, config, spec, diagnostic, or workflow change risks preserving legacy behavior through aliases, silent fallbacks, alternate paths, or hidden defaults. Do not use for edits where no compatibility or defaulting decision is involved."
---
