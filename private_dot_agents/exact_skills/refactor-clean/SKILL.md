---
name: refactor-clean
description: "Use when the user explicitly asks for a behavior-preserving refactor of non-ML production code, guided by tests and simplification. Do not use for feature work, behavior-changing bug fixes, active ML experiments, or generic cleanup without a refactor request."
