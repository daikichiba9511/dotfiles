...
description: "Use only when the user explicitly asks to create a Git commit or invokes commit; inspect the intended diff, choose a Conventional Commit message, and commit the selected changes. Do not trigger merely because code changes are complete."
---
