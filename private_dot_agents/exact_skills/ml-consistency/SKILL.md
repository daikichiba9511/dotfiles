---
name: ml-consistency
description: "Use to audit parity between ML training, validation, and inference paths, including preprocessing, features, checkpoints, thresholds, and postprocessing. Trigger when metric drift or deployment mismatch suggests train/serve skew; do not use for dataset quality or general error analysis."
