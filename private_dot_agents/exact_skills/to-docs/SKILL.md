---
name: to-docs
description: "Use only when the user asks to turn the current conversation or session decisions into a standalone Markdown handoff or record. Do not use for updating existing project documentation from code changes."
