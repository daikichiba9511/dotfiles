---
name: tdd
description: "Use only when the user explicitly requests test-driven development, RED-GREEN-REFACTOR, or test-first implementation. Do not trigger merely because tests should be added or run."
