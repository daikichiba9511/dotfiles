...
description: "Use when operating pueue as a single-GPU ML experiment scheduler: configure queues, enqueue train or evaluation jobs, inspect status or logs, chain post-run analysis, or update notes from queued outputs. Do not use for one foreground experiment or non-ML job scheduling."
---
