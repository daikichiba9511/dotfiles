---
name: spec-behavior
description: "Use when authoring or reviewing a software behavior specification expressed as a conversion table or Mermaid state machine, including states, events, guards, actions, and invariants. Do not use for architecture diagrams, implementation flowcharts, or prose-only requirements."
