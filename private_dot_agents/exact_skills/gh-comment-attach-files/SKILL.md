...
description: "Use when the user needs local files uploaded to a GitHub issue or pull request composer solely to obtain GitHub-hosted attachment URLs without submitting a comment. Do not use for posting or editing comments, or for ordinary GitHub operations."
---
...
```bash
deno run -A ~/.agents/skills/gh-comment-attach-files/scripts/attach_comment_files.ts \
