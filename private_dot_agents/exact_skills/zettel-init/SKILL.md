---
name: zettel-init
description: "Use when the user explicitly asks to initialize a Zettelkasten, add its base structure, or create a new theme directory in an existing Zettelkasten. Do not use for generic documentation workspaces or creating an individual note."
