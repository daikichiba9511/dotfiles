---
name: ml-docs
description: "Use only for the repository's three-layer ML experiment documentation workflow: initialize it, plan proposals, record results, update the evidence and compact layers, or explain its commands. Do not use for generic experiment notes or ordinary documentation."
