---
name: llm-wiki-init
description: "Use when the user explicitly asks to initialize a new persistent LLM Wiki or source-backed knowledge base with its directory schema and control files. Do not use to add sources to an existing wiki."
