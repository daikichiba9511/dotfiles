---
name: llm-wiki-guide
description: "Use when the user asks how the existing LLM Wiki workflow works or which of init, ingest, query, and lint to use. Do not use to initialize, ingest, query, or lint a wiki."
---
