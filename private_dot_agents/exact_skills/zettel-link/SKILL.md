---
name: zettel-link
description: "Use when the user asks to analyze relationships among existing Zettel notes, propose cross-links, or update a link map. Do not use for creating new notes, composing a document, or general semantic search."
