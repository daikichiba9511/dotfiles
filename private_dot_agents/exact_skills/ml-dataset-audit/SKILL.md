...
description: "Use to audit an ML dataset, feature table, split, or labeling pipeline for leakage, duplicates, schema drift, missingness, imbalance, contamination, and train/validation/test skew. Do not use for model failure analysis after predictions already exist."
